...
このドキュメントは、GitHub Projects V2 で構築されたプロジェクト管理環境の運用方法を説明します。
`set-up-github-project` プレイブックでセットアップされた環境を前提としています。
...
本プレイブックでセットアップされたプロジェクトは、GitHub Projects V2 を活用した開発プロジェクト管理環境です。
